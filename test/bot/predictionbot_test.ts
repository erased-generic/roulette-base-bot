...
function testParser(
  instance: PredictionBot,
  command: string,
  expected: PredictCommand | undefined
) {
...
testHandler(aChatContext, "!predict 100 1", /a predicted 1 with 100 points/);
testHandler(aChatContext, "!predict 100 101", /error/);
testHandler(aChatContext, "!predict 100 1 2 3", /error/);
testHandler(aChatContext, "!predict 100 1-2", /error/);
testHandler(aChatContext, "!predict lol 101", /error/);
testHandler(aChatContext, "!predict lol lol", /error/);
testHandler(aChatContext, "!predict 1000 1", /You don't have that many points/);
testHandler(
  aChatContext,
  "!predict -1000 1",
  /You can bet only a positive amount of points/
);
testHandler(aChatContext, "!unpredict", /not predicting anymore/);
testHandler(
  modChatContext,
  "!outcome 1",
...
testHandler(modChatContext, "!outcome 1", /Prediction resulted in outcome '1'/);

// test that non-mods can't open or close predictions
testHandler(aChatContext, "!open", /Peasant a, you can't open predictions!/);
testHandler(aChatContext, "!close", /Peasant a, you can't close predictions!/);

// test that you can't predict when predictions are closed
testHandler(aChatContext, "!predict 100 1", /Predictions are closed/);
...
testHandler(aChatContext, "!predict all 1", /a predicted 1 with 0 points/);
testHandler(aChatContext, "!unpredict", /not predicting anymore/);
...
testHandler(aChatContext, "!predict 10 2", /a predicted 2 with 10 points/);
testHandler(
  aChatContext,
  "!balance",
...
testHandler(aChatContext, "!predict 10 1", /a predicted 1 with 10 points/);
testHandler(bChatContext, "!predict 50 2", /b predicted 2 with 50 points/);
testHandler(
  aChatContext,
  "!balance",
  /You have 100 points \(currently betted 10 of those\),/
...
testHandler(aChatContext, "!balance", /You have 150 points,/);
testHandler(bChatContext, "!balance", /You have 50 points,/);
...
testHandler(aChatContext, "!predict 100 1", /a predicted 1 with 100 points/);
testHandler(bChatContext, "!predict all 2", /b predicted 2 with 0 points/);
testHandler(
  aChatContext,
  "!balance",
  /You have 100 points \(currently betted 100 of those\),/
);
testHandler(bChatContext, "!balance", /You have 0 points,/);
testHandler(
  modChatContext,
  "!outcome 2",
  new RegExp(
...
testHandler(aChatContext, "!balance", /You have 0 points,/);
testHandler(bChatContext, "!balance", /You have 100 points,/);
